...
const getAllPlans = () => {
  ...
  console.log(`Hitting ${process.env.REACT_APP_BACKEND_URL}/api/plans`)
  return axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/plans`);
};
...
const deletePlanByID = (id) => {
  ...
  return axios.delete(`${process.env.REACT_APP_BACKEND_URL}/api/plans/${id}`);
}
